document.getElementById('submitButton').addEventListener('click', function() {
    ...
    const ha = document.querySelector('input[name="ha"]:checked').value;
    ...
    report += "<li><strong>Event flow rate:</strong> <span style='color: " + (eventFlowRate > 200 ? 'red' : 'black') + "'>" + eventFlowRate + "</span></li>";
    report += "<li><strong>Object Server Trigger Stats:</strong> <span style='color: " + (triggerStats < -10 || triggerStats > 50 ? 'red' : 'black') + "'>" + triggerStats + "</span></li>";
    report += "<li><strong>Object Server Profiling:</strong> <span style='color: " + (profiling < -10 || profiling > 50 ? 'red' : 'black') + "'>" + profiling + "</span></li>";
    report += "<li><strong># of Custom Triggers/Procedures created:</strong> " + customTriggers + "</li>";
    report += "<li><strong>User restriction filters created:</strong> " + restrictionFilters + "</li>";
    report += "</ul>";
